...
public class MultiMaterialModelNodeSample : CommonSample
{
    ...
    private void AddRemoveSubMesh(SubMesh? subMesh, bool addSubMesh)
    {
        ...
        if (addSubMesh)
            ...
            _multiMaterialModelNode.RemoveSubMesh(subMesh, removeUnusedMaterials: false); // set removeUnusedMaterials=false to prevent removal of the material from the _multiMaterialModelNode
    }
